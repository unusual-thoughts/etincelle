...
{'package_name': 'Devialet.WhatsUp',
  'services': [{'name': 'Registrar',
                'methods': [{'name': 'registerServer',
                            ...
                            {'name': 'pingRequested',
                             ...
                             'output_type': 'Devialet.CallMeMaybe.Empty'}]},
               {'name': 'Registry',
                'methods': [{'name': 'getNetworkConfiguration',
                             'input_type': 'Devialet.CallMeMaybe.Empty',
 ...
 {'package_name': 'Devialet.TooManyFlows',
  'services': [{'name': 'Metadata', 'methods': []},
               {'name': 'Configuration',
                'methods': [{'name': 'addPlayer',
 ...
 {'package_name': 'Devialet.GetThePartyStarted.Player',
  'services': [{'name': 'Configuration', 'methods': []},
               {'name': 'Setup',
                'methods': [{'name': 'startStandaloneSetup',
 ...
 {'package_name': 'Devialet.AudioSource',
  'services': [{'name': 'LiveSourceSession',
                'methods': [{'name': 'picture',
                             'input_type': 'Devialet.CallMeMaybe.Empty',
 ...
 {'package_name': 'Devialet.TwerkIt',
  'services': [{'name': 'SoundDesign',
                'methods': [{'name': 'allDeviceDone',
                             'input_type': 'Devialet.CallMeMaybe.Empty',
                             'output_type': 'Devialet.CallMeMaybe.Empty'},
 ...
 {'package_name': 'Devialet.SpotifyConnect',
  'services': [{'name': 'Agent',
                'methods': [{'name': 'handleZeroConfApiRequest',
 ...
 {'package_name': 'Devialet.CallMeMaybe',
  'services': [{'name': 'Connection',
                'methods': [{'name': 'openConnection',
